...
BASE_OUTPUT_DIR="/tud/value-adapters/culturellm/eval_outputs/offenseval"
ADAPTERS_DIR="/tud/models/averaged"
...
for MODEL_NAME in "${models[@]}"; do
    ...
    for adapter_lang in "${adapter_languages[@]}"; do
        ...
        for task in ${combined_tasks[$adapter_lang]}; do
            # Define output directory for storing evaluation results
            ADAPTER_PATH="${ADAPTERS_DIR}/${MODEL_TYPE}/averaged"
