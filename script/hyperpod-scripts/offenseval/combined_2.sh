#!/bin/bash
#SBATCH --job-name="combined-2"
#SBATCH --output="/tud/outputs/run_baseline_combined_2.out"
#SBATCH --gres=gpu:1
#SBATCH -N 1 
#SBATCH -A nlp-dept 
#SBATCH -p nlp-dept 
...
# BASE_MODEL_NAME="llama-3.1-8B-it"
